...
/// \file ms5840.h
///
/// \brief    ms5840 Temperature, pressure and humidity sensor driver header file
///
...
enum ms5840_humidity_i2c_controller_mode {
	ms5840_i2c_hold,
	ms5840_i2c_no_hold
};
...
enum ms5840_status {
	...
	ms5840_status_heater_on_error,
	ms5840_status_i2c_read_unimplemented,
	ms5840_status_i2c_write_unimplemented,
	ms5840_status_i2c_write_no_stop_unimplemented,
	ms5840_status_sleep_ms_unimplemented
};

enum ms5840_humidity_resolution {
	ms5840_humidity_resolution_12b = 0,
	ms5840_humidity_resolution_8b,
	ms5840_humidity_resolution_10b,
	ms5840_humidity_resolution_11b
};

enum ms5840_battery_status {
	ms5840_battery_ok,
	ms5840_battery_low
};

enum ms5840_heater_status {
	ms5840_heater_off,
	ms5840_heater_on
};
...
typedef struct ms5840_host_functions {
	...
	///          that returns `ms5840_status_callback_error`. The caller
	///          should then prevent any use of the MS5840's "hold" mode.
	///
	///          This callback is optional: the MS5840 driver can retrieve
	///          readings from the MS5840 sensor without it, but it becomes
	///          necessary if the sensor is used in "hold" mode
	///          (`ms5840_humidity_i2c_controller_mode : ms5840_i2c_hold`).
	///
	/// \return  ms5840_status : Lets the driver know if the I2C transmit was successful.
	///        - ms5840_status_ok : I2C transfer completed successfully
	///        - ms5840_status_callback_error : Problem with i2c transfer
	///
	enum ms5840_status  (*i2c_controller_write_no_stop)(void *caller_context, ms5840_i2c_controller_packet *const);
...
typedef struct ms5840_sensor {
	...
	enum ms5840_humidity_i2c_controller_mode   hsensor_i2c_controller_mode;
	enum ms5840_pressure_resolution            psensor_resolution_osr;
	ms5840_bool                                hsensor_heater_on;
...
///       - ms5840_status_callback_error : Error occurred within a ms5840_host_functions function
///
enum ms5840_status ms5840_set_humidity_resolution(ms5840_sensor *sensor, enum ms5840_humidity_resolution, void *caller_context);
...
///       - ms5840_status_null_sensor : The pointer provided for the `sensor` parameter was NULL.
///
enum ms5840_status ms5840_set_humidity_i2c_controller_mode(ms5840_sensor *sensor, enum ms5840_humidity_i2c_controller_mode, void *caller_context);
...
///
enum ms5840_status ms5840_read_temperature_pressure_humidity_int32(ms5840_sensor *sensor, int32_t *, int32_t *, int32_t *, void *caller_context);
...
///       - ms5840_status_measurement_invalid : EEPROM is OK and I2C transfer completed, but data received was invalid
///
enum ms5840_status ms5840_read_temperature_pressure_humidity_float32(ms5840_sensor *sensor, float *, float *, float *, void *caller_context);
...
///       - ms5840_status_callback_error : Error occurred within a ms5840_host_functions function
///
enum ms5840_status ms5840_get_battery_status(ms5840_sensor *sensor, enum ms5840_battery_status*, void *caller_context);
...
///       - ms5840_status_callback_error : Error occurred within a ms5840_host_functions function
///
enum ms5840_status ms5840_get_heater_status(ms5840_sensor *sensor, enum ms5840_heater_status*, void *caller_context);
...
///
enum ms5840_status ms5840_get_compensated_humidity(ms5840_sensor *sensor, float, float, float*);
...
///       - ms5840_status_heater_on_error : Cannot compute compensated humidity because heater is on
///
enum ms5840_status ms5840_get_dew_point(ms5840_sensor *sensor, float, float, float*);
...
#if 0
// TODO: remove?
enum ms5840_status hsensor_poll_relative_humidity(ms5840_sensor *sensor, float *humidity, void *caller_context);
enum ms5840_status hsensor_write_command(ms5840_sensor *sensor, uint8_t, void *caller_context);
